      ...
      <main class=" max-w-[1000px] mx-auto">
            ...
            <section class="area-calculator max-w-[1000px] bg-gray-100">
                  ...
                  <form action="" class="p-5">
                        <div>
                              <label for="input-email-label">Your Width</label>
                              <input type="number" id="input-email-label" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                        </div>
                        <div class=" my-3">
                              <label for="input-email-label">Your Height</label>
                              <input type="number" id="input-email-label" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                        </div>
                        <button type="button" class="py-3 w-full justify-center px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                              Calculate
                        </button>
                  </form>
            </section>
